...
func (trans *Sitrans) handle_msg(msg *sipmess.SIPMessage) {
	...
	if msg.Request != nil {
		...
		} else if msg.Request.Method == sipmess.Invite && trans.state == completed {
			trans.call_transport_callback(trans.last_res)
		}
		return
	}
...
func (sitrans Sitrans) call_core_callback(message *sipmess.SIPMessage) {
...
func (sitrans Sitrans) call_transport_callback(message *sipmess.SIPMessage) {
